...
(function($) {
  window.initMap = function() {
    ...
    function initStyledMap(map) {
      markerCluster = new MarkerClusterer(map, [], {imagePath: "../img/markerCluster", minimumClusterSize: '4'});
      var mapSkin = [
        {
    ...
    function initSearch(map) {
      ...
      google.maps.event.addListener(autoComplete, 'place_changed', function() {
        ...
        console.log("new location"); // this is where to sort and set
    ...
    function addMarker(map, data) {
      ...
      var types = data.attributes.field_category_id[0];
      ...
      categories.forEach(function(nextCategory) {
        if (filterColours[nextCategory]) {
          ...
          listHTML += '<span class="list-category">' + categoryNames[types] + '</span><br>'
